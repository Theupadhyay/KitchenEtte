...
$('.button-area').on('click', 'button', function() {
  ...
  if(currqty == 0)
  {
    ...
    $("#" + tempId+".order-item").find(".qty").text(currqty);
    $("#" + tempId + ".order-item").find(".amount").text(currqty * currprice);
  }
...
function updatecart() {
  ...
  $("section#cart .wrapper .middle-container .totalAm-container .Sum").text(totalAm);
};
...
$(".item-box").on('click', '.reset-btn-area .reset-btn', function(){
  ...
  for(let i = 0;i<tempVar.length;i++)
  {
    ...
    $("section#cart .wrapper .middle-container .container .order-items .order-item#"+tempN).remove();
  }
  updatecart();
});
...
$("section#cart .wrapper .order-button .order-now").click(function() {
  var lengthvar = $("section#cart .wrapper .middle-container .container .order-items .order-item").length;
  ...
  if(lengthvar == 1){
    ...
    $("section#cart .wrapper .middle-container .container .order-items .otheritems").remove();
    $("section#cart .wrapper .middle-container .totalAm-container .Sum").text(0);
    $("section#menu .menu-container .item-box .items .item .button-area .value").text(0);
  }
});
